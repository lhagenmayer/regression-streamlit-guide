...
from data import (
    safe_scalar, generate_dataset, get_signif_stars, get_signif_color,
    COLORS, FONT_SIZES
)
from plot_factory import (
    create_regression_mesh, get_3d_layout_config, create_zero_plane,
    create_plotly_scatter, create_plotly_scatter_with_line,
    create_plotly_3d_scatter, create_plotly_3d_surface,
    create_plotly_residual_plot, create_plotly_bar,
    create_plotly_distribution, create_r_output_display
)
...
# Nur bei Einfacher Regression: Zeige die bestehenden Kapitel
    ...
    **Das Konfidenzintervall (hellblauer Bereich):**
    ...
    # Note: create_r_output_figure is not implemented, using text output instead
    r_output_text = create_r_output_display(model, feature_name=x_label, get_signif_stars_func=get_signif_stars)
    st.code(r_output_text, language=None)
