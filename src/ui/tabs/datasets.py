...
This module renders the datasets information tab showing available datasets
...
def render_datasets_tab() -> None:
    ...
    This tab provides detailed information about all available datasets
    including their characteristics, variables, and ideal use cases.
    """
    ...
    _render_elektronikmarkt_section()
    
    st.markdown("---")
    
    # Dataset 2: Städte-Umsatzstudie
    _render_stadte_section()
    
    st.markdown("---")
    
    # Dataset 3: Häuserpreise
    _render_hauser_section()
...
def _render_elektronikmarkt_section() -> None:
    """Render the Elektronikmarkt dataset section."""
...
def _render_stadte_section() -> None:
    """Render the Städte-Umsatzstudie dataset section."""
...
def _render_hauser_section() -> None:
    """Render the Häuserpreise dataset section."""
...
def _render_comparison_table() -> None:
    """Render the datasets comparison table."""
