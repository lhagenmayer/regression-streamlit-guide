"""
Plot factory functions for creating various regression visualizations.
"""
...
# ---------------------------------------------------------
def create_r_output_display(model, feature_name="X", get_signif_stars_func=None):
    """
    ...
    Args:
        ...
        feature_name: Name of the feature/predictor variable
        get_signif_stars_func: Function to get significance stars
    """
    # Extract all values
    resid = model.resid
    ...
    if get_signif_stars_func is None:
        ...
        def get_signif_stars(p):
            ...
            if p < 0.1:   return '.'
            return ' '
        get_signif_stars_func = get_signif_stars
...
(Intercept)  {params[0]:9.4f} {bse[0]:8.4f} {tvals[0]:7.2f} {pvals[0]:10.4g} {get_signif_stars_func(pvals[0])}
{feature_name:<13}{params[1]:9.4f} {bse[1]:8.4f} {tvals[1]:7.2f} {pvals[1]:10.4g} {get_signif_stars_func(pvals[1])}
---
