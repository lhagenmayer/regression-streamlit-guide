...
class TestGenerateDataset:
    ...
    def test_generate_dataset_haeuser(self):
        ...
        assert (
            set(result["x_pool"]) == {0.0, 1.0}
            or set(result["x_pool"]) == {0.0}
            or set(result["x_pool"]) == {1.0}
        )
...
class TestGenerateMultipleRegressionData:
    ...
    def test_elektronikmarkt_dataset(self):
        ...
        result = generate_multiple_regression_data(
            "🏪 Elektronikmarkt (erweitert)", n_mult=50, noise_mult_level=0.35, seed_mult=42
        )
    ...
    def test_variable_sample_size(self):
        ...
        for n in [20, 50, 100, 150]:
            result = generate_multiple_regression_data(
                "🏙️ Städte-Umsatzstudie (75 Städte)", n_mult=n, noise_mult_level=3.5, seed_mult=42
            )
    ...
    def test_variable_noise_level(self):
        ...
        result_low = generate_multiple_regression_data(
            "🏙️ Städte-Umsatzstudie (75 Städte)", n_mult=75, noise_mult_level=1.0, seed_mult=42
        )

        result_high = generate_multiple_regression_data(
            "🏙️ Städte-Umsatzstudie (75 Städte)", n_mult=75, noise_mult_level=8.0, seed_mult=42
        )
    ...
    def test_reproducibility(self):
        ...
        result1 = generate_multiple_regression_data(
            "🏙️ Städte-Umsatzstudie (75 Städte)", n_mult=75, noise_mult_level=3.5, seed_mult=999
        )
...
class TestGenerateSimpleRegressionData:
    ...
    def test_staedte_werbung(self):
        ...
        result = generate_simple_regression_data(
            "🏙️ Städte-Umsatzstudie (75 Städte)", "Werbung (CHF1000)", n=75, seed=42
        )
    ...
    def test_haeuser_wohnflaeche(self):
        ...
        result = generate_simple_regression_data(
            "🏠 Häuserpreise mit Pool (1000 Häuser)", "Wohnfläche (sqft/10)", n=1000, seed=42
        )
    ...
    def test_haeuser_pool(self):
        ...
        result = generate_simple_regression_data(
            "🏠 Häuserpreise mit Pool (1000 Häuser)", "Pool (0/1)", n=1000, seed=42
        )
    ...
    def test_reproducibility(self):
        ...
        result1 = generate_simple_regression_data(
            "🏙️ Städte-Umsatzstudie (75 Städte)", "Preis (CHF)", n=75, seed=123
        )
    ...
    def test_different_seeds_produce_different_data(self):
        ...
        result2 = generate_simple_regression_data(
            "🏙️ Städte-Umsatzstudie (75 Städte)", "Preis (CHF)", n=75, seed=999
        )
...
class TestEdgeCases:
    ...
    def test_small_sample_size(self):
        ...
        result = generate_multiple_regression_data(
            "🏙️ Städte-Umsatzstudie (75 Städte)", n_mult=20, noise_mult_level=3.5, seed_mult=42
        )
    ...
    def test_zero_noise(self):
        ...
        result = generate_multiple_regression_data(
            "🏪 Elektronikmarkt (erweitert)", n_mult=50, noise_mult_level=0.0, seed_mult=42
        )
    ...
    def test_high_noise(self):
        ...
        result = generate_multiple_regression_data(
            "🏙️ Städte-Umsatzstudie (75 Städte)", n_mult=75, noise_mult_level=100.0, seed_mult=42
        )
